 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PartPrice3 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PartPrice3';
...
'unit_profit' => 'getUnitProfit'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['unit_profit'] = isset($data['unit_profit']) ? $data['unit_profit'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['unit_profit'] === null) {
            $invalidProperties[] = "'unit_profit' can't be null";
        }
     ...
     * @return float
     */
    public function getUnitProfit()
    {
        return $this->container['unit_profit'];
    }

    /**
     * Sets unit_profit
     *
     * @param float $unit_profit unit_profit
     *
     * @return $this
     */
    public function setUnitProfit($unit_profit)
    {
        $this->container['unit_profit'] = $unit_profit;
