 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShipTo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ShipTo';
...
'alternate_name' => 'getAlternateName'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['alternate_id'] === null) {
            $invalidProperties[] = "'alternate_id' can't be null";
        }
        if ($this->container['alternate_name'] === null) {
            $invalidProperties[] = "'alternate_name' can't be null";
        }
